...
model1.add(Convolution2D(6,kernel_size=(5,5),padding="same", input_shape=(28,28,1),activation='relu'))

model1.add(MaxPooling2D(pool_size=(2,2)))

model1.add(Convolution2D(16,kernel_size=(5,5),padding="valid", input_shape=(14,14,6),activation='relu'))

model1.add(MaxPooling2D(pool_size=(2,2)))

model1.add(Flatten())
model1.add(Dense(120,activation='sigmoid'))
model1.add(Dense(84,activation='softmax'))
